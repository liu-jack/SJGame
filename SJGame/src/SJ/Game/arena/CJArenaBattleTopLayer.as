package SJ.Game.arena
{
	...
	public class CJArenaBattleTopLayer extends SLayer
	{
		private var _relayhandler:CJBattleReplayManager;	
		private var _showfast:Boolean = false;
		private var _button_back:Button;
		
		public function CJArenaBattleTopLayer(ReplayManager:CJBattleReplayManager)
		{
			super();
		...
		private function _onClickBack(e:Event):void
		{
			switch((e.currentTarget as Button).name)
			{
				case "end":
					...
					{
						CJMessageBox(CJLang("ARENA_SUZHANSUJUE_DISABLE"),function():void
						{
