package SJ.Game.Example
{
	...
	public class CJExampleLayer extends SLayer
	{
		public function CJExampleLayer()
		{
			super();
...
//				SApplication.stateManager.ChangeState("GameStateGaming",{"battletype":0});
				SApplication.moduleManager.exitModule("CJExampleModule");
				SApplication.moduleManager.enterModule("CJBattleModule",{"battletype":0});
			});
...
//				SApplication.stateManager.ChangeState("GameStateGaming",{"battletype":1});
				SApplication.moduleManager.exitModule("CJExampleModule");
				SApplication.moduleManager.enterModule("CJBattleModule",{"battletype":1});
			});
...
//				SApplication.stateManager.ChangeState("GameStateGaming",{"battletype":2});
				SApplication.moduleManager.exitModule("CJExampleModule");
				SApplication.moduleManager.enterModule("CJBattleModule",{"battletype":2});
			});
...
//				SApplication.stateManager.ChangeState("GameStateGaming",{"battletype":3});
				SApplication.moduleManager.exitModule("CJExampleModule");
				SApplication.moduleManager.enterModule("CJBattleModule",{"battletype":3});
			});
...
//					{
//						SocketManager.o.connect("192.168.0.220",9001);
//						SocketManager.o.addEventListener(CJSocketEvent.SocketEventConnect,
//							function _connect(e:Event):void
//							{
//								e.target.removeEventListener(e.type,_connect);
//								
//								SocketCommand_account.login("abcd","111111");
////								var md5:MD5 = new MD5;
////								var bytes:ByteArray = new ByteArray;
////								bytes.writeUTFBytes("abc");
////								
////								var hashString:String = Hex.fromArray(md5.hash(bytes));
////								SocketManager.o.call(ConstNetCommand.CS_LOGIN,"abc",hashString);
//							});
//					}
//					else
//					{
...
//						{
//							trace("logined:" + (e.data as SocketMessage).params(1));
