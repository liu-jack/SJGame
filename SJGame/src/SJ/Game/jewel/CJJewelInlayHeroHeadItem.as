package SJ.Game.jewel
{
	 ...
	 * 
	 */	
	public class CJJewelInlayHeroHeadItem extends CJItemTurnPageBase
	{
		/** 控件宽度 **/
		...
		public function CJJewelInlayHeroHeadItem()
		{
			super("CJJewelInlayHeroHeadItem");
		}
...
//					_imgHeroIconBG.color = 0xFFFFFF;
//					_imgHeroIcon.color = 0xFFFFFF;
					if(filter != null)
					{
						filter.dispose();
					}
				...
				{
					_imgHeroIconBG.source = SApplication.assets.getTexture("common_wujiangkuang");
//					_imgHeroIconBG.color = 0x7F7F7F;
//					_imgHeroIcon.color = 0x7F7F7F;
					if(filter != null)
					{
						filter.dispose();
					}
...
//			_imgHeroIconBG.source = SApplication.assets.getTexture("common_wujiangkuangxuanzhong");
			...
			var enhanceLayer:CJJewelInlayLayer = this.owner.parent.parent as CJJewelInlayLayer;
			enhanceLayer.onSelectHero(this.data.heroid);
