package SJ.Game.rank
{
	 ...
	 * 
	 */	
	public class CJRankRichLevelLayer extends CJRankBaseOperateLayer
	{
		//显示面板
		...
		/** 自己消耗的总元宝数*/
		private var _myUseGold:Number;
		public function CJRankRichLevelLayer()
		{
			super();
			ConstRank.RANK_TYPE = ConstRank.RANK_TYPE_RANK_RICH_LEVEL;
		}
		...
		private function _initData():void
		{
			...
			_myUseGold = _roleData.expensegold;
		...
		{
			_listData = _rankData.rankRichData;
			...
			labelMyCurData.text = CJLang("RANK_MY_USE_GOLD", {"myusegold":_myUseGold});
		}
