package SJ.Game.rank
{
	 ...
	 * 
	 */	
	public class CJRankBattleLevelLayer extends CJRankBaseOperateLayer
	{
		//显示面板
		...
		/** 自己的总战斗力 */
		private var _myBattlePower:int;
		public function CJRankBattleLevelLayer()
		{
			super();
			ConstRank.RANK_TYPE = ConstRank.RANK_TYPE_RANK_BATTLE_LEVEL;
		}
		...
		private function _initData():void
		{
			...
			_myBattlePower = int(CJDataManager.o.DataOfHeroList.getMainHero().battleeffectsum)
		...
		{
			_listData = _rankData.rankBattleData;
			...
			labelMyCurData.text = CJLang("RANK_MY_BATTLE_POWER", {"mybattlepower":_myBattlePower});
		}
