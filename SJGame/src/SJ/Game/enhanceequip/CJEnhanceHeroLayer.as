package SJ.Game.enhanceequip
{
	 ...
	 * @date 2013-06-08
	 */	
	public class CJEnhanceHeroLayer extends SLayer
	{
		/** 翻页按钮宽度 **/
		...
		public function CJEnhanceHeroLayer()
		{
			super();
		}
		...
		private function _drawContent():void
		{
			...
			_heroPanel.setRect(width-CONST_PANEL_CUT_WIDTH , height-CONST_PANEL_CUT_HEIGHT - CONST_BUTTON_HEIGHT - CONST_BUTTON_HEIGHT);
		...
		private function _doInit():void
		{
			...
			{
				const render:CJEnhanceHeroHeadItem = new CJEnhanceHeroHeadItem();
