package SJ.Game.enhanceequip
{
	 ...
	 * 
	 */	
	public class CJEnhanceHeroHeadItem extends CJItemTurnPageBase
	{
		/** 控件宽度 **/
		...
		public function CJEnhanceHeroHeadItem()
		{
			super("CJEnhanceHeroHeadItem");
		}
...
//					_imgHeroIcon.color = 0x7F7F7F;
		...
		{
			var enhanceLayer:CJEnhanceEquipLayer = this.owner.parent.parent as CJEnhanceEquipLayer;
