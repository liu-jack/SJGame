package com.sammyjoeosborne.spriter.utils 
{
	...
	public class ScmlParser extends EventDispatcher
	{
		...
		public function startWithXML(xmldate:XML):void
		{
			_scmlData.scmlXML = XML(xmldate);
			parseScml(_scmlData);
		}
...
//						else
//						{
//							$key.prevPropsDirty = false;
//							$key.prev.nextPropsDirty = false;
//							$key.prevPivotDirty 		= false;
//							$key.prev.nextPivotDirty 	= false;
//							$key.prevFileDirty			= false;
//							$key.prev.nextFileDirty		= false;
//						}
