package lib.engine.ui.uicontrols.builder
{
	...
	public class XDG_UI_Builder_Tooltip extends XDG_UI_Builder
	{
		public function XDG_UI_Builder_Tooltip(IResourceBuilder:IResource)
		{
		...
		{
			return type == XDG_UI_Data_Tooltips.TYPE;
		}
		
		override public function CreateCtrlInfo(type:String, name:String=null):XDG_UI_Data
		{
			var control:XDG_UI_Data = new XDG_UI_Data_Tooltips();
			if(name != null)
			{
				control.name = name;
			}
			...
			{
				control.name = "unname-tooltip_"+CTimerUtils.getCurrentTime();
			}
			return control;
		}
		...
		{
			var _ctrl:XDG_UI_Control = new XDG_UI_Tooltip();
