package fxengine.game.texture
{
	...
	public class FTexture
	{
		...
		public function FTexture(image:BitmapData = null) {
			image_ = image;
		}
		...
		public static function textureFromURL(url:String) : FTexture {
			var texture:FTexture = new FTexture();
		...
		{
			return new FRect(0,0,width,height);
		}
		/** texture name */
		...
		public function drawInRect(rect:FRect) : BitmapData {
			if (image == null) {
				return null;
			}
			...
			if (rect == null) {
				...
				bmd.copyPixels(image, rect, new FPoint(0, 0));
				return bmd;
			}
		}
	}
